...
function Login() {
  ...
  const validateForm = () => {
    ...
    tempErrors.password = password.length > 5 ? "" : "Minimum 6 characters required";
    tempErrors.rePassword = rePassword === password ? "" : "Passwords must match";
  ...
  const forgotPassword = async (e) => {
    e.preventDefault();
    navigate('/forgot-password'); // Add the route you set for the PasswordAssistance component
};
        ...
        {isRegistering ? (
          ...
          <>
            ...
            <form>
              ...
              {errors.rePassword && <p className="login__error">{errors.rePassword}</p>}

              <button type='submit' onClick={register} className='login__continueButton'>Continue</button>
            </form>
            <p>
          ...
          <>
            ...
            <div className='login__actions'>
              <button onClick={forgotPassword} className='login__forgotPasswordButton'>
                  Forgot Password
              </button>
              <button onClick={showRegisterForm} className='login__registerButton'>
